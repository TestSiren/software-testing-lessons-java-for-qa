...
public record AddressData(String firstname, String middlename,
    ...
    public AddressData withFirstname(String value) {
        return new AddressData(value, middlename, lastname, nickname, title, company, address, home,
    ...
    public AddressData withMiddlename(String value) {
        return new AddressData(firstname, value, lastname, nickname, title, company, address, home,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withLastname(String value) {
        return new AddressData(firstname, middlename, value, nickname, title, company, address, home,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withNickname(String value) {
        return new AddressData(firstname, middlename, lastname, value, title, company, address, home,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withTitle(String value) {
        return new AddressData(firstname, middlename, lastname, nickname, value, company, address, home,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withCompany(String value) {
        return new AddressData(firstname, middlename, lastname, nickname, title, value, address, home,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withAddress(String value) {
        return new AddressData(firstname, middlename, lastname, nickname, title, company, value, home,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withHome(String value) {
        return new AddressData(firstname, middlename, lastname, nickname, title, company, address, value,
                mobile, work, fax, email, email2, email3, homepage, bday, bmonth, byear,
                aday, amonth, ayear, group);
    }
    public AddressData withMobile(String value) {
        return new AddressData(firstname, middlename, lastname, nickname, title, company, address, home,
